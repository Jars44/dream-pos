  ...
  return (
    <AuthWrapper>
      <div className="text-left mb-4">
        ...
        <p className="text-slate-500 text-sm">Create New Dreamspos Account</p>
      </div>
      ...
      <form className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            />
            <User className="absolute right-3 top-1/2 -translate-y-1/2 size-5 text-slate-400" />
          </div>
        </div>
        ...
        <div className="flex items-start space-x-2 pt-1">
          <Checkbox
            ...
            className="border-slate-300 data-[state=checked]:bg-orange-500 data-[state=checked]:border-orange-500 mt-0.5"
          />
          <label htmlFor="terms" className="text-sm text-slate-600 select-none leading-tight">
            I agree to the{" "}
        ...
        <Button
          type="submit"
          className="w-full h-11 bg-orange-500 hover:bg-orange-600 text-white font-semibold text-base transition-all duration-200 mt-6"
        >
          Sign Up
        </Button>
        ...
        <div className="text-center text-sm text-slate-600">
          ...
          <a href="/auth/sign-in" className="text-orange-500 hover:text-orange-600 font-medium">
            Sign In Instead
          </a>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <Button
            type="button"
            variant="outline"
            className="h-11 bg-white hover:bg-slate-50 text-slate-700 border-slate-200 font-medium"
          >
