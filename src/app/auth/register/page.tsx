    ...
    <AuthWrapper>
      ...
      <form className="space-y-4">
        ...
        <div className="flex items-start space-x-2 pt-1">
          ...
          />
          <label htmlFor="terms" className="text-sm text-slate-600 select-none cursor-pointer leading-tight">
            I agree to the{" "}
        ...
        <div className="text-left text-sm text-slate-600">
          ...
          <a href="/auth/sign-in" className="text-slate-800 hover:text-slate-900 font-medium">
            Sign In Instead
          </a>
        </div>
